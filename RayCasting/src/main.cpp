...
void initDiffuse(Geometry::Scene & scene)
{
	...
	Geometry::Material * cubeMat1 = new Geometry::Material(RGBColor(), RGBColor(5, 0.0, 0.0), RGBColor(0.0, 0.0, 0.0), 20.0f, RGBColor());
	Geometry::Material * cubeMat2 = new Geometry::Material(RGBColor(), RGBColor(5.0f,0.0,0.0), RGBColor(0.0,0.0,0.0), 20.0f, RGBColor(0,0,0)) ;
